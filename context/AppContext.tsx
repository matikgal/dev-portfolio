...
const translations = {
  en: {
    ...
    hero: {
      ...
      description: 'I build accessible, pixel-perfect, and performant web experiences. Focusing on the React ecosystem and modern UI engineering.',
    ...
    about: {
      ...
      timeline: {
        title: 'My Journey',
        steps: [
          { year: '2024', title: 'Internship at Rekord SI', desc: 'Completed programming internship. Gained practical experience working with commercial systems and development workflows.' },
          { year: '2023', title: 'Computer Science Degree', desc: 'Started university studies specializing in Software Engineering. Deep diving into algorithms and architecture.' },
          { year: '2019', title: 'IT Technical High School', desc: 'Began formal IT education. Learned basics of hardware, networking, and wrote first lines of code.' },
        ]
      },
      toolbox: {
        title: 'Toolbox',
    ...
    projects: {
      ...
      subtitle: 'A collection of commercial projects, experiments, and open-source contributions. Each project represents a unique challenge and a learning opportunity.',
    ...
    contact: {
      ...
      subtitle: "I'm currently looking for new opportunities as a Frontend Developer. Whether you have a question or just want to say hi, my inbox is always open.",
  ...
  pl: {
    ...
    hero: {
      ...
      status: 'Szukam pracy',
      role: 'Frontend Developer',
      description: 'Tworzę dostępne, dopracowane i wydajne aplikacje internetowe. Skupiam się na ekosystemie React i nowoczesnej inżynierii UI.',
    ...
    about: {
      ...
      timeline: {
        title: 'Moja Ścieżka',
        steps: [
          { year: '2024', title: 'Praktyki w Rekord SI', desc: 'Odbycie praktyk programistycznych. Praca w realnym środowisku deweloperskim i poznanie procesów wytwarzania oprogramowania.' },
          { year: '2023', title: 'Studia Informatyczne', desc: 'Rozpoczęcie studiów o specjalizacji Inżynieria Oprogramowania. Zgłębianie inżynierii systemów i zaawansowanej algorytmiki.' },
          { year: '2019', title: 'Technikum Informatyczne', desc: 'Początek edukacji w IT. Nauka budowy sprzętu, sieci komputerowych oraz pierwsze linie kodu.' },
        ]
      },
      toolbox: {
        title: 'Narzędzia',
    ...
    projects: {
      title: 'Moje Projekty',
      subtitle: 'Zbiór projektów i eksperymentów. Każda aplikacja to dla mnie okazja do nauki nowych rozwiązań i szlifowania warsztatu.',
    ...
    contact: {
      ...
      subtitle: "Aktualnie poszukuję pracy jako Junior Frontend Developer. Jeśli masz pytania lub propozycję współpracy, moja skrzynka jest otwarta.",
